...
const PENDING_TABLES: TableMigration[] = [
  ...
  // 0052 — Buyer Portal foundation (see docs/architecture/buyer-portal-foundation-spec.md)
  {
  ...
  {
    table: "customer_account_members",
    ddl: `CREATE TABLE IF NOT EXISTS \`customer_account_members\` (
  \`id\` int AUTO_INCREMENT NOT NULL,
  ...
  // 0053 — Buyer Portal: invoice links (pro_billing_cycles ↔ customer_accounts)
  {
    table: "customer_invoice_links",
    ddl: `CREATE TABLE IF NOT EXISTS \`customer_invoice_links\` (
  \`id\` int AUTO_INCREMENT NOT NULL,
  \`customer_account_id\` int NOT NULL,
