...
/**
 * Creates an in-app notification and, when `companyId` is set, records a compliance row in `audit_events`.
 * Pass `audit.actorUserId` when a user triggered the notification (otherwise null for system-generated).
 */
