...
/** Full sector list (aligned with client CreateCompanyPage INDUSTRIES). Order: finance → built env → energy → tech → trade → services → hospitality → health/edu → logistics → manufacturing → agri → professional → public → other */
const CP_SECTOR_OPTIONS: OptionDef[] = [
