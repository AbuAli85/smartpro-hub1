...
export function buildSanadDirectoryOutreachBodyAr(
  ...
  sections.push(
    [
      ...
      "تحية طيبة وبعد،",
      "",
      "نودّ إفادتكم بأن «المندوب الذكي» — مبادرة رقمية متخصصة في تطوير وتنظيم الخدمات المهنية في سلطنة عُمان — يعمل حالياً على تنفيذ مسارات تنسيق تهدف إلى تعزيز التكامل ورفع كفاءة التعامل مع مراكز «سند» المعتمدة.",
    ].join("\n"),
  );
