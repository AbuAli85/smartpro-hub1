                  ...
                  outreachDisplayRows.map((row) => {
                    ...
                    const waMessage = row.surveyUrl
                      ? tWhatsappOutreach("admin.whatsappSurveyMessage", {
                          ...
                          defaultValue:
                            "السلام عليكم ورحمة الله وبركاته،\n\nنفيدكم بأن هذه الرسالة تتصل باستبيان قطاع الأعمال الرسمي في سلطنة عُمان (منصة سمارت برو / برنامج مكاتب سند)، لجمع معلومات قطاعية للتخطيط والإفادة الرسمية.\n\nالمنشأة:\n{{officeName}}\n\nوفيما يلي الرابط الإلكتروني المباشر لاستكمال الاستبيان (يرجى فتح الرابط وإكمال الاستبيان عبر المتصفح):\n{{surveyUrl}}\n\nشكراً لتعاونكم،",
                        })
                      : tWhatsappOutreach("admin.whatsappSurveyMessageNoLink", {
                          officeName: officeWa,
                          defaultValue:
                            "السلام عليكم ورحمة الله وبركاته،\n\nنفيدكم بأن هذه الرسالة تتصل باستبيان قطاع الأعمال الرسمي في سلطنة عُمان (منصة سمارت برو / برنامج مكاتب سند)، لجمع معلومات قطاعية للتخطيط والإفادة الرسمية.\n\nالمنشأة:\n{{officeName}}\n\nلم يُرفق رابط إلكتروني في هذه الرسالة؛ فنرجو التكرم بالرد عليها في الوقت المناسب ليتم إرسال رابط الاستبيان إليكم.\n\nشكراً لتعاونكم،",
                        });
