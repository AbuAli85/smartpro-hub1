...
import { isProfileFieldKey, PROFILE_FIELD_KEY_LABELS } from "@shared/profileChangeRequestFieldKey";
                          ...
                          >
                            <div className="flex flex-wrap items-start justify-between gap-2">
                              <div className="min-w-0 space-y-1">
                                ...
                                {typeof r.fieldKey === "string" && isProfileFieldKey(r.fieldKey) ? (
                                  <p className="text-[10px] text-muted-foreground">{PROFILE_FIELD_KEY_LABELS[r.fieldKey]}</p>
                                ) : null}
